            ...
            <div class="row">
                 <?php
                    ...
                    if ($res) {
                        ...
                        ?>
                        <center>
                            <form action="modificar3.php" method="post" class="form-horizontal formu" role="form" name="form">
                                <table class="tablaCentrada" cellspacing="3" cellpadding="3">
                                    ...
                                    <tr>
                                        ...
                                        <td class="relleno blanco">
                                            <input type="text" name="title" value="<?php echo $reg["title"]; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="relleno gris">Descripción</td>
                                        <td class="relleno blanco">
                                            <input type="text" name="descr" value="<?php echo $reg["descripcion"]; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="relleno gris">Nombre de la Imagen</td>
                                        <td class="relleno blanco">
                                            <input type="text" name="image" value="<?php echo $reg["image"]; ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="relleno gris">Fecha</td>
                                        <td class="relleno blanco">
                                            <input type="text" name="date" value="<?php echo $reg["date"]; ?>">
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                <button type="button" class="btn btn-warning botonGuardar" onClick="modificar()">Guardar Cambios</button>
                            </form>
                        </center>
                        <?php
                        }else{
