...
<body onLoad="limpiar()">
    ...
    <div class="section_area">
        <div class="container">
            <div class="row">
                <h2 class="text-center">Modificar Imágenes</h2>
                <br/><br/>
                <?php
                ...
                ?>
                <br/><br/>
                <form action="modificar2.php" method="post" class="form-horizontal formu" role="form" name="form">
                  <div class="form-group">
                    <label for="identificador" class="col-sm-3 control-label">ID</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="identificador" placeholder="Ingresa el ID de la imagen a modificar">
                    </div>
                  </div>
                  <div class="form-group">
