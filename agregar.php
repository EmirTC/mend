...
<body onLoad="limpiar()">
    ...
    <div class="section_area">
        <div class="container">
            <div class="row">
            <h2 class="text-center">Agregar Imágenes</h2>
                <br/><br/>
                 <?php
                ...
                <br/><br/>
                <center>
                    <form action="agregar2.php" method="post" class="form-horizontal formu" role="form" name="form">
                        ...
                        <br/>
                        <button type="submit" class="btn btn-success botonGuardar">Agregar</button>
                    </form>
                </center>
            </div>
        </div>
